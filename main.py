...
def record_audio(ask=False):
    with sr.Microphone() as micro: # microphone as source
        if ask:
            speak(ask)
        audio = r.listen(micro)  # listen for the audio via source
        voice_data = ''
        try:
...
def respond(voice_data):
    ...
    if there_exists([" what is your name"," what's your name"," tell me your name"]):
        if person_obj.name:
            speak(" my name is nayan")
        else:
            speak("my name is nayan. what's your name?")
